 ...
 *  <h1>Movimentacao</h1>
 * 
 *  <p> Classe representativa da entidade movimentação</p>
 *  
 * @author Mateus A.S
 */
@Entity
...
public class Movimentacao {
	 ...
	 * 
	 * @param id parâmetro id do objeto Movimentação
	 * @param dataMovimentacao parâmetro dataMovimentacao do objeto Movimentação
	 * @param itemMovimentado parâmetro itemMovimentado do objeto Movimentação
	 * @param ambienteAnterior parâmetro ambienteAnterior do objeto Movimentação
	 * @param ambientePosterior parâmetro ambientePosterior do objeto Movimentação
	 * @param movimentador parâmetro movimentador do objeto Movimentação
	 */
	...
	/** Identificação dos diferentes registros de movimentações.
	...
	/** Objeto que representa o registro do ambiente em que o item estava anexado anteriormente */
	@ManyToOne
	...
	/**
	 * 	Define o número de identificação do Usuário
	...
	/**
	 * Retorna um objeto Date que representa a data em que a movimentação foi efetuada
	 * 
	...
	/**
	 * Define um objeto date que representá a data em que foi efetuada a movimentação
	 * 
	 * @param dataMovimentacao objeto Date representando a data em que foi efetuada a movimentação
	 */
	 ...
	 * 
	 * @param itemMovimentado objeto Item que será anexado a movimentação
	 */
	...
	/**
	 * Retorna um objeto Ambiente populado com os dados do registro do ambiente anterior
	 * 
	...
	/**
	 * Define um objeto Ambiente que representará o ambiente em que o item se encontrava
	 * 
	 * @param ambienteAnterior objeto Ambiente que será anexado como ambiente anterior
	 */
	...
	/**
	 *  Retorna um objeto Ambiente populado com os dados do registro do ambiente posterior
	 *  
	...
	/**
	 *  Define um objeto Ambiente que representará o ambiente em que o item  irá se encontrar
	 *   
	 * @param ambientePosterior objeto Ambiente que será anexado com ambiente posterior
	 */
	...
	/**
	 * Retorna um objeto Usuário populado com os dados do registro do usuário movimentador
	 * 
	 ...
	 * 
	 * @param movimentador objeto Usuário que será anexado a movimentação como movimentador
	 */
